...
if __name__ == "__main__":
    ...
    record_step_file_name = "build_log/sqlite-3.45.0.ini"
    ...
    steps: list[tuple[str, Dict[str, str]]] = [
        ("get_source_code", {   "work_path"  : "sheer_third_party",
                                "clone_path" : "libraries/sqlite-src",
                                "url"        : "https://github.com/sqlite/sqlite.git",
                                "version"    : "version-3.45.0"}),
        ("pre_build", { "work_path"        : "sheer_third_party",
                        "source_path"      : "libraries/sqlite-src",
                        "version"          : "3.45.0",
                        "pre_install_path" : "libraries/sqlite"}),
    ...
    try:
        ...
        for step_name, step_data in steps:
            ...
            if step_id == 1:
                ...
                configure_param1: str = "--prefix=" + install_path
